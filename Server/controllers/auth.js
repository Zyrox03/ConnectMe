...
export const verifyEmail = catchAsync(async (req, res) => {
    ...
    req.login(user, (err) => {
        ...
        return res.redirect(`https://woozy-kindhearted-brie.glitch.me/?user=${encodeURIComponent(userData)}`);
    });
})
...
export const renderReset = catchAsync(async (req, res) => {
    ...
    try {
        ...
        return res.redirect(`https://woozy-kindhearted-brie.glitch.me/?resetP=${user.userID}`);
